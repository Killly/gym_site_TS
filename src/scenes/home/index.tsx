...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section
        id="home"
        className="gap-16 bg-cyan-100 py-10 md:h-full md:pb-0"
    >
        ...
        >
            ...
            {/*IMAGE*/}
            <div className="md:flex basis-3/5 justify-center mt-6 md:z-10
        ...
        {isAboveMediumScreens && (
            <div className="h-[150px] w-full bg-cyan-300 bg-opacity-30 py-10">
